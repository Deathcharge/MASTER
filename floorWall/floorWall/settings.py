"""
Django settings for floorWall project.
...
ALLOWED_HOSTS = ['45.56.90.194','www.awarddev.com','awarddev.com']
...
WSGI_APPLICATION = 'floorWall.wsgi.application'
